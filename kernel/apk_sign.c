...
static apk_sign_key_t apk_sign_keys[] = {
    ...
    { EXPECTED_SIZE_VORTEX, EXPECTED_HASH_VORTEX }, // kingfinik98/VorteX (VorteXSU)
    ...
    { EXPECTED_SIZE_KAMISU, EXPECTED_HASH_KAMISU }, // KamiSU
    { EXPECTED_SIZE_ZIXINESU, EXPECTED_HASH_ZIXINESU }, // ZixineSu
#ifdef EXPECTED_SIZE
